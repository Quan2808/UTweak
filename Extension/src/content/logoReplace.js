...
var logoReplace = part1ss + part2ss;

// Placeholder for custom CSS styles
...
function loadLogoReplacement() {
  if (!logoReplace || !css) {
    console.log("[Logo Replace] No custom logo or CSS defined");
    return;
  }
  ...
  if (document.getElementById("logo-icon")) {
    ...
    logoIcons.forEach((logoIcon) => {
      logoIcon.insertAdjacentHTML("afterend", logoReplace);
